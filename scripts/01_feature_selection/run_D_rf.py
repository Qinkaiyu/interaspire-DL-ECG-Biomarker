#!/usr/bin/env python3
"""Step D: Random Forest permutation importance for ECG biomarkers."""
...
log("Fitting Random Forest (200 trees, single-threaded) …")
...
ecg_imp=rf_imp[[v for v in ECG_ALL if v in feat_names]]
ecg_std=rf_std[[v for v in ECG_ALL if v in feat_names]]
...
out.to_csv(OUT_DIR/"rf_importance.csv",index=False)

log("\nRF permutation importance (ECG vars, sorted):")
...
log("Saved → results/feature_selection/rf_importance.csv")
log("✓ Step D done.")
