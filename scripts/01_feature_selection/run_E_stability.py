#!/usr/bin/env python3
"""Step E: Bootstrap stability selection (50 runs, LASSO)."""
...
for b in range(N_BOOT):
    ...
    Xb, yb = Xf[idx], y[idx]
    m = LogisticRegression(penalty="l1", C=BEST_C, solver="liblinear",
...
out.to_csv(OUT_DIR/"stability_selection.csv",index=False)
...
log("Saved → results/feature_selection/stability_selection.csv")
log("✓ Step E done.")
