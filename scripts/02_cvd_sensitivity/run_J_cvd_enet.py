#!/usr/bin/env python3
"""Step J: Elastic Net — CVD composite endpoint."""
...
enet_cv=LogisticRegressionCV(Cs=np.logspace(-3,1,20),cv=5,penalty="elasticnet",
    l1_ratios=[0.5],solver="saga",scoring="roc_auc",max_iter=3000,
